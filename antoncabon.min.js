!function(){function f(){var a=document.createElement("div");a.id="antoncabon";a.innerHTML='<div class="inner"> <div class="header"> <h2 style="color:red">Ad Blocker Detected</h2> </div> <div class="areablock"> <p>Please consider supporting us by disabling your ad blocker</p> <br>Refresh the page if it didn\'t refresh automatically. Thanks! </div> </div><div class="tombol"><a href="<button type="button" class="1 active">Refresh Page</button></div>';
