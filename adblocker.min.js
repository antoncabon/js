!function(){function f(){var a=document.createElement("div");a.id="antoncabon";a.innerHTML='<div class="inner"> <div class="header"> <h2>Ad Blocker Detected</h2> </div> <div class="areablock"> <p>Please consider supporting us by disabling your ad blocker</p> <br><li>Refresh the page if it didn\'t refresh automatically. Thanks!</li> </div> </div>';
